...
date: |
 |
 | Version 0.6.3 DRAFT `r format(Sys.Date(), "%Y-%m-%d")`
 |
...
params:
  ...
  # provincial scientific fish collection permit. Names the submission workbook at
  # data/permit_submission/<permit_id>.xlsx and is linked from 2400-Attachment_data.Rmd.
  # A second permit, WL25-993485 (Williams Lake / Cariboo), produced no data and is
  # closed out with the Province as a nil return - nothing is submitted under it.
  permit_id: "PG25-983997"
  model_species: "bt"
  ...
  # Regenerate the Culvert Data / Model Data popup pages under docs/sum/ that the
  # results interactive map links to. The underlying data changes rarely and the
  # pages are committed, so this stays FALSE for a normal build - see template#231.
  update_html_map_tables: FALSE
...
source('scripts/02_reporting/0190-build-html-map-tables.R')
# site map functions - must follow 0120, which creates the globals they read
# (`wshds`, `habitat_confirmation_tracks`, `pscis_assessment_svw`)
source("scripts/02_reporting/0420-map-site.R")
