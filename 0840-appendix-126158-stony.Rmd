...
```{r map-126158, fig.cap = my_caption, fig.width = 9, fig.height = 7, dpi = 150, out.width = photo_width}
my_caption <- paste0("Habitat confirmation site map for PSCIS crossing ", my_site, ".", " ", lfpr_map_credit(my_site))

lfpr_map_site(site = my_site)
```
